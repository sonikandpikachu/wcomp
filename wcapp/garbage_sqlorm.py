...
from wcconfig import GARBAGE_CONNECTION_STRING
from sqlalchemy.schema import Column
 
#connetcting to database
engine = al.create_engine(GARBAGE_CONNECTION_STRING, echo=False)
...
class wc_OS (Base):
    ...
    def __init__( self, dssv = None, name = None, dssc = None, url = None ):
        self.dssv = dssv
        self.name = name
        self.dssc = dssc
        self.url = url
...
class wc_Battery (Base):
    ...
    def __init__( self, dssv = None, capacity = None, voltage = None, power = None, dssc = None, url = None ):
        self.dssv = dssv
...
class wc_Screen (Base):
    ...
    def __init__( self, dssv = None, cover = None, resolution = None, dssc = None, size = None, url = None ):
        self.dssv = dssv
        self.cover = cover
...
class wc_RAM (Base):
    ...
    def __init__( self, dssv = None, amount = None, dssc = None, name = None, max_amount = None, url = None ):
        self.dssv = dssv
        self.amount = amount
        self.dssc = dssc
        self.name = name
...
class wc_VGA (Base):
    ...
    def __init__( self, dssv = None, amount = None, type = None, name = None, dssc = None, url = None ):
        self.dssv = dssv
        self.amount = amount
        self.type = type
        self.name = name
...
class wc_CDevice (Base):
    ...
    def __init__( self, price = None, id_wc_Computer = None, id_wc_Shop = None, url = None ):
        self.price = price
        self.id_wc_Shop = id_wc_Shop
        self.id_wc_Computer = id_wc_Computer
        self.url = url
...
class wc_CPU (Base):
    ...
    def __init__( self, kernel_count = None, dssc = None, mark = None, frequency = None, dssv = None, type = None, url = None ):
...
class wc_HD (Base):
    ...
    def __init__( self, info = None, dssc = None, mark = None, dssv = None, amount = None, ssd_amount = None, interface = None, speed = None, url = None ):
        self.info = info
        self.dssc = dssc
        self.mark = mark
        self.dssv = dssv
